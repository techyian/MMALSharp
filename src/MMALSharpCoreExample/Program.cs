...
namespace MMALSharpCoreExample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AsyncContext.Run(async () =>
            {
                ...
                */
                ...
                using (var imgEncoder = new MMALImageEncoder(new ImageStreamCaptureHandler("/home/pi/images/", "bmp"), MMALEncoding.MMAL_ENCODING_BMP, MMALEncoding.MMAL_ENCODING_RGB32, 90))
                {
