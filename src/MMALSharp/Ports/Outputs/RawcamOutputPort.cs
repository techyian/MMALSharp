...
{
    public unsafe class RawcamOutputPort : OutputPort
    {
        /// <inheritdoc />
        ...
        public RawcamOutputPort(IntPtr ptr, IComponent comp, Guid guid)
            : base(ptr, comp, guid)
        {
        }
        ...
        public RawcamOutputPort(IPort copyFrom)
        ...
        public override void Configure(IMMALPortConfig config, IInputPort copyFrom, IOutputCaptureHandler handler)
        {
            ...
            this.CallbackHandler = new DefaultOutputPortCallbackHandler(this, handler, null);
        }
        ...
        internal override void NativeOutputPortCallback(MMAL_PORT_T* port, MMAL_BUFFER_HEADER_T* buffer)
        {
            ...
            {
                MMALLog.Logger.LogDebug($"In native {nameof(RawcamOutputPort)} output callback");
            }
