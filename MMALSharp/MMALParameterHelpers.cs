            ...
            try
            {
                ...
                switch (t.Value.Name)
                {
                    case "MMAL_PARAMETER_BOOLEAN_T":
                        ...
                        break;
                    case "MMAL_PARAMETER_UINT64_T":
                        MMALCheck(MMALUtil.mmal_port_parameter_set_uint64(ptr, (uint)key, (ulong)value), "Unable to get ulong value");
                        break;
                    case "MMAL_PARAMETER_INT64_T":
                        MMALCheck(MMALUtil.mmal_port_parameter_set_int64(ptr, (uint)key, (long)value), "Unable to get long value");
                        break;
                    case "MMAL_PARAMETER_UINT32_T":
                        MMALCheck(MMALUtil.mmal_port_parameter_set_uint32(ptr, (uint)key, (uint)value), "Unable to get uint value");
                        break;
                    case "MMAL_PARAMETER_INT32_T":
                        MMALCheck(MMALUtil.mmal_port_parameter_set_int32(ptr, (uint)key, (int)value), "Unable to get int value");
                        break;
                    case "MMAL_PARAMETER_RATIONAL_T":
                        MMALCheck(MMALUtil.mmal_port_parameter_set_rational(ptr, (uint)key, (MMAL_RATIONAL_T)value), "Unable to get rational value");
                        break;
                    case "MMAL_PARAMETER_STRING_T":
                        MMALCheck(MMALUtil.mmal_port_parameter_set_string(ptr, (uint)key, (string)value), "Unable to get rational value");
                        break;
                    default:
                        throw new NotSupportedException();
                }
