...
namespace SharPicam.Native
{
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCommon.MMAL_CORE_STATS_DIR dir;
        public int reset;
        public MMAL_CORE_STATISTICS_T stats;

        public MMAL_PARAMETER_CORE_STATISTICS_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCommon.MMAL_CORE_STATS_DIR dir, int reset,
    ...
    public static class MMALParametersCamera
    {
        ...
        public const int MMAL_PARAM_EXPOSUREMODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAM_EXPOSUREMETERINGMODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAM_AWBMODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAM_IMAGEFX_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAM_STC_MODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAM_FLICKERAVOID_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_FLASH_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_REDEYE_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_FOCUS_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_CAPTURE_STATUS_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_FOCUS_STATUS_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_FACE_DETECT_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAM_TIMESTAMP_MODE_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAMETER_CAMERA_INFO_FLASH_TYPE_MAX = 0x7FFFFFFF;
        ...
        public const int MMAL_PARAMETER_DRC_STRENGTH_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAMETER_ALGORITHM_CONTROL_ALGORITHMS_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAM_CAMERA_USE_CASE_MAX = 0x7fffffff;
        ...
        public const int MMAL_PARAMETER_PRIVACY_INDICATOR_MAX = 0x7fffffff;
        ...
        public const int MMAL_STEREOSCOPIC_MODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_CAMERA_INTERFACE_MAX = 0x7fffffff;
        ...
        public const int MMAL_CAMERA_CLOCKING_MODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_CAMERA_RX_CONFIG_DECODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_CAMERA_RX_CONFIG_ENCODE_MAX = 0x7fffffff;
        ...
        public const int MMAL_CAMERA_RX_CONFIG_UNPACK_MAX = 0x7fffffff;
        ...
        public const int MMAL_CAMERA_RX_CONFIG_PACK_MAX = 0x7fffffff;
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_EXPOSUREMODE_T value;

        public MMAL_PARAMETER_EXPOSUREMODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_EXPOSUREMODE_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_EXPOSUREMETERINGMODE_T value;

        public MMAL_PARAMETER_EXPOSUREMETERINGMODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_EXPOSUREMETERINGMODE_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_AWBMODE_T value;

        public MMAL_PARAMETER_AWBMODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_AWBMODE_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_IMAGEFX_T value;

        public MMAL_PARAMETER_IMAGEFX_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_IMAGEFX_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_IMAGEFX_T effect;
        public uint numEffectParams;
        public uint[] effectParameter;

        public MMAL_PARAMETER_IMAGEFX_PARAMETERS_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_IMAGEFX_T effect,
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_CAMERA_STC_MODE_T value;

        public MMAL_PARAMETER_CAMERA_STC_MODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_CAMERA_STC_MODE_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_FLICKERAVOID_T value;

        public MMAL_PARAMETER_FLICKERAVOID_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_FLICKERAVOID_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_FLASH_T value;

        public MMAL_PARAMETER_FLASH_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_FLASH_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_REDEYE_T value;

        public MMAL_PARAMETER_REDEYE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_REDEYE_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_FOCUS_T value;

        public MMAL_PARAMETER_FOCUS_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_FOCUS_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_CAPTURE_STATUS_T value;

        public MMAL_PARAMETER_CAPTURE_STATUS_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_CAPTURE_STATUS_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_FOCUS_STATUS_T value;

        public MMAL_PARAMETER_FOCUS_STATUS_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_FOCUS_STATUS_T value)
        {
            this.hdr = hdr;
            this.value = value;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_FACE_TRACK_MODE_T mode;
        public uint maxRegions, frames, quality;

        public MMAL_PARAMETER_FACE_TRACK_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_FACE_TRACK_MODE_T mode,
    ...
    public struct MMAL_PARAMETER_CAMERA_CONFIG_T
    {
        ...
        public MMALParametersCamera.MMAL_PARAMETER_CAMERA_CONFIG_TIMESTAMP_MODE_T useSTCTimestamp;
        ...
        public MMAL_PARAMETER_CAMERA_CONFIG_T(MMAL_PARAMETER_HEADER_T hdr, uint maxStillsW, uint maxStillsH, uint stillsYUV422, 
                                              ...
                                              MMALParametersCamera.MMAL_PARAMETER_CAMERA_CONFIG_TIMESTAMP_MODE_T useSTCTimestamp)
        {
            this.hdr = hdr;
    ...
    {
        public MMALParametersCamera.MMAL_PARAMETER_CAMERA_INFO_FLASH_TYPE_T flashType;

        public MMAL_PARAMETER_CAMERA_INFO_FLASH_T(MMALParametersCamera.MMAL_PARAMETER_CAMERA_INFO_FLASH_TYPE_T flashType)
        {
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAMETER_CAPTUREMODE_MODE_T mode;

        public MMAL_PARAMETER_CAPTUREMODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAMETER_CAPTUREMODE_MODE_T mode)
        {
            this.hdr = hdr;
            this.mode = mode;
        }
    ...
    public struct MMAL_PARAMETER_FOCUS_REGION_T
    {
        ...
        public MMALParametersCamera.MMAL_PARAMETER_FOCUS_REGION_TYPE_T type;

        public MMAL_PARAMETER_FOCUS_REGION_T(MMAL_RECT_T rect, uint weight, uint mask, MMALParametersCamera.MMAL_PARAMETER_FOCUS_REGION_TYPE_T type)
        {
            this.rect = rect;
            this.weight = weight;
            this.mask = mask;
    ...
    public struct MMAL_PARAMETER_FLASH_SELECT_T
    {
        ...
        public MMAL_PARAMETER_FLASH_SELECT_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAMETER_CAMERA_INFO_FLASH_TYPE_T flashType)
        {
            this.hdr = hdr;
            this.flashType = flashType;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAMETER_DRC_STRENGTH_T strength;

        public MMAL_PARAMETER_DRC_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAMETER_DRC_STRENGTH_T strength)
        {
            this.hdr = hdr;
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAMETER_ALGORITHM_CONTROL_ALGORITHMS_T algorithm;
        public int enabled;

        public MMAL_PARAMETER_ALGORITHM_CONTROL_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAMETER_ALGORITHM_CONTROL_ALGORITHMS_T algorithm,
                                                  int enabled)
        {
            this.hdr = hdr;
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_CAMERA_USE_CASE_T useCase;

        public MMAL_PARAMETER_CAMERA_USE_CASE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_CAMERA_USE_CASE_T useCase)
        {
            this.hdr = hdr;
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_PARAM_PRIVACY_INDICATOR_T mode;

        public MMAL_PARAMETER_PRIVACY_INDICATOR_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_PARAM_PRIVACY_INDICATOR_T mode)
        {
            this.hdr = hdr;
            this.mode = mode;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_STEREOSCOPIC_MODE_T mode;
        public int decimate, swapEyes;
        
        public MMAL_PARAMETER_STEREOSCOPIC_MODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_STEREOSCOPIC_MODE_T mode,
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_CAMERA_INTERFACE_T mode;

        public MMAL_PARAMETER_CAMERA_INTERFACE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_CAMERA_INTERFACE_T mode)
        {
            this.hdr = hdr;
            this.mode = mode;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_CAMERA_CLOCKING_MODE_T mode;

        public MMAL_PARAMETER_CAMERA_CLOCKING_MODE_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_CAMERA_CLOCKING_MODE_T mode)
        {
            this.hdr = hdr;
            this.mode = mode;
        }
    ...
    {
        public MMAL_PARAMETER_HEADER_T hdr;
        public MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_DECODE decode;
        public MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_ENCODE encode;
        public MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_UNPACK unpack;
        public MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_PACK pack;
        public uint dataLanes, encodeBlockLength, embeddedDataLines, imageId;

        public MMAL_PARAMETER_CAMERA_RX_CONFIG_T(MMAL_PARAMETER_HEADER_T hdr, MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_DECODE decode,
                                                 MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_ENCODE encode, MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_UNPACK unpack,
                                                 MMALParametersCamera.MMAL_CAMERA_RX_CONFIG_PACK pack,
